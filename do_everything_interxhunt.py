...
wraps.interxhunt_cratio_models(trainDf, "Deck_A_Win?", cats, conts, models)

valDf["Predicted"] = misc.predict(valDf, models, calculus.Cratio_mlink)
valDf["Actual"] = valDf["Deck_A_Win?"]

print("GINI: " + str(metrics.get_gini(valDf,"Predicted","Actual")))
p, a = metrics.get_Xiles(valDf,"Predicted","Actual")
...
wraps.viz_cratio_models(models, "Cratio_sep1")
